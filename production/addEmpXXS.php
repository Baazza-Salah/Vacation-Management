...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $cnie = filter_input(INPUT_POST, 'cnie', FILTER_SANITIZE_STRING);
    $dob = filter_input(INPUT_POST, 'dob', FILTER_SANITIZE_STRING);
    $gender = filter_input(INPUT_POST, 'gender', FILTER_SANITIZE_STRING);
    $situation = filter_input(INPUT_POST, 'situation', FILTER_SANITIZE_STRING);
    $ppr = filter_input(INPUT_POST, 'ppr', FILTER_SANITIZE_STRING);
    ...
    $date_affectation = filter_input(INPUT_POST, 'date_affectation', FILTER_SANITIZE_STRING);
    $echelon = filter_input(INPUT_POST, 'echelon', FILTER_SANITIZE_STRING);
                                    ...
                                    <div id="wizard" class="form_wizard wizard_horizontal">
                                        ...
                                        <form class="form-horizontal form-label-left" action="addemployee.php" method="POST">
                                            <div id="step-1">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="cnie">CIN <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6">
                                                        <input type="text" name="cnie" class="form-control has-feedback-left" placeholder="CIN" required>
                                            ...
                                            <div id="step-2">
                                                <div class="form-group row">
                                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="situation">Family Status <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6">
                                                        <input type="text" name="situation" class="form-control has-feedback-left" placeholder="Family Status" required>
                                            ...
                                            <div id="step-3">
                                                <div class="form-group row">
                                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="date_affectation">Date of Assignment <span class="required">*</span></label>
                                                    <div class="col-md-6 col-sm-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <textarea name="adresse" class="form-control has-feedback-left" placeholder="Address" required></textarea>
