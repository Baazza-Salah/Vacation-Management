...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $cnie = htmlspecialchars($_POST['cnie'], ENT_QUOTES, 'UTF-8');
    ...
    if (!$numPPR) {
        ...
        $successMessage = "Request Number: N~" . htmlspecialchars($idDemande, ENT_QUOTES, 'UTF-8');
        
        // Redirect to avoid resubmitting form data
        header("Location: requestXSS.php?successMessage=" . urlencode($successMessage));
        exit();
    }
}
?>
...
<body>
    ...
    <div class="container mt-5">
        ...
        <?php elseif (isset($_GET['successMessage'])): ?>
            <div class="alert alert-success"><?php echo htmlspecialchars($_GET['successMessage'], ENT_QUOTES, 'UTF-8'); ?></div>
        <?php endif; ?>
        <form action="requestxss.php" method="POST">
            <div class="mb-3">
